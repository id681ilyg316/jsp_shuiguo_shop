...
public class Fbsp extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "insert into pros values('"+proname+"','"+cpcj+"','"+cand+"','"+protype+"','"+mprice+"','"+price+"','"+tgrs+"','"+discount+"','"+kucun+"','"+yujin+"','"+filename+"','"+content+"','','"+Info.getDateStr()+"')";
