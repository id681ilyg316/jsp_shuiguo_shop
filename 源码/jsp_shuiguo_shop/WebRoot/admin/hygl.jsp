...
PageManager pageManager = PageManager.getPage("/shuiguo_shop/hygl.jsp?1=1", 10, request);
...
for(HashMap h:list)
{
 %>
          ...
          <td height="26" align="center" bgcolor="#FFFFFF" class=""><a href="upmember.jsp?id=<%=h.get("id") %>">修改</a>      </td>    
          <td height="26" align="center" bgcolor="#FFFFFF" class="">
          <a href="/shuiguo_shop/admin/hygl.jsp?did=<%=h.get("id") %>"> 删除</a>            </td>
          </tr>
 <%
 }
  %>          
...
共 <%=records %> 条记录
                                ...
                                <a href="/shuiguo_shop/admin/hygl.jsp?">首页</a>
                                
                                &nbsp;&nbsp;
                                
                                <a href="/shuiguo_shop/admin/hygl.jsp?dpagee=<%=dpage-1 %>">上页</a>
                                
                                &nbsp;&nbsp;
                                
                                <a href="/shuiguo_shop/admin/hygl.jsp?dpagee=<%=dpage+1 %>">下页</a>
                                
                                &nbsp;&nbsp;
                                
                                
                                <a href="/shuiguo_shop/admin/hygl.jsp?dpagee=<%=pages %>">末页</a>
