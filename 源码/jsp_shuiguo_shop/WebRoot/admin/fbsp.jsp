...
%>
<body>
<form  action="fbsp.jsp?f=f&tglparentid=<%=tglparentid%>"  name="f1"  onsubmit="return checkform()" >
<table width="95%" border="0" align="center"  cellpadding="0" cellspacing="0" >
  <tr>
    <td height="28" colspan="2" align="center"><strong>发布水果</strong></td>
  </tr>
  <tr>
...
<tr>
    ...
    <td width="1024" height="28" align="left"><%=Info.getselect("protype","protype","typename~无名"," 1=1 ")%> 
