...
if(docname!=null)
{
 ...
 var txt = parent.document.getElementById("filetxt4");
 var docname = parent.document.getElementById("docname4");
 docname.value="<%=docname%>";
 popclose();
 </script>
 <%} %>
<form action="/shuiguo_shop/shuiguo_shop?ac=uploaddoc4" enctype="multipart/form-data" name="f1" method="post">
