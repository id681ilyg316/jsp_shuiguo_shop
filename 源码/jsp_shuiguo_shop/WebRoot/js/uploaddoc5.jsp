...
if(docname!=null)
{
 ...
 var txt = parent.document.getElementById("filetxt5");
 var docname = parent.document.getElementById("docname5");
 docname.value="<%=docname%>";
 popclose();
 </script>
 <%} %>
<form action="/shuiguo_shop/shuiguo_shop?ac=uploaddoc5" enctype="multipart/form-data" name="f1" method="post">
